                ...
                <div style="display:flex;gap:1.2rem;flex-wrap:wrap;">
                    ...
                    <div style="flex:1;min-width:180px;margin-bottom:1rem;">
                        ...
                        <div style="display:flex;align-items:center;position:relative;">
                            <input type="password" name="therapist_password" id="therapist_password" class="form-control" required style="width:100%;padding:0.7rem 2.5rem 0.7rem 1rem;border-radius:0.7rem;border:1.5px solid #e6eaf3;font-size:1.05rem;margin-top:0.3rem;">
