  ...
  <div style="
    ...
    <main style="flex:1;font-family:'Segoe UI',Roboto,Arial,sans-serif;">
        ...
        <div style="max-width:600px;margin:2.5rem auto 2rem auto;background:#f8fafd;padding:2rem 2rem 1.5rem 2rem;border-radius:1.2rem;box-shadow:0 2px 8px rgba(0,0,0,0.04);">
            ...
            <h3 style="font-size:1.2rem;font-weight:600;margin-bottom:1.2rem;color:#232a32;">Edit Therapist</h3>
            <?php if (!empty($msg)) echo $msg; ?>
            <form method="post" enctype="multipart/form-data">
                <div style="display:flex;gap:1.2rem;flex-wrap:wrap;">
                    <div style="flex:1;min-width:180px;margin-bottom:1rem;">
                        <label style="font-weight:500;">Name</label>
                        <input type="text" name="therapist_name" class="form-control" required value="<?= htmlspecialchars($therapist['therapist_name']) ?>" style="width:100%;padding:0.7rem 1rem;border-radius:0.7rem;border:1.5px solid #e6eaf3;font-size:1.05rem;margin-top:0.3rem;">
                    </div>
                    <div style="flex:1;min-width:180px;margin-bottom:1rem;">
                        <label style="font-weight:500;">Email</label>
                        <input type="email" name="therapist_email" class="form-control" required value="<?= htmlspecialchars($therapist['therapist_email']) ?>" style="width:100%;padding:0.7rem 1rem;border-radius:0.7rem;border:1.5px solid #e6eaf3;font-size:1.05rem;margin-top:0.3rem;">
                    </div>
                </div>
                <div style="display:flex;gap:1.2rem;flex-wrap:wrap;">
                    <div style="flex:1;min-width:180px;margin-bottom:1rem;">
                        <label style="font-weight:500;">Phone</label>
                        <input type="text" name="therapist_phone" class="form-control" required value="<?= htmlspecialchars($therapist['therapist_phone_number']) ?>" style="width:100%;padding:0.7rem 1rem;border-radius:0.7rem;border:1.5px solid #e6eaf3;font-size:1.05rem;margin-top:0.3rem;">
                    </div>
                    <div style="flex:1;min-width:180px;margin-bottom:1rem;">
                        <label style="font-weight:500;">Strength</label>
                        <input type="number" name="therapist_strength" class="form-control" required min="1" max="5" value="<?= htmlspecialchars($therapist['therapist_strength']) ?>" style="width:100%;padding:0.7rem 1rem;border-radius:0.7rem;border:1.5px solid #e6eaf3;font-size:1.05rem;margin-top:0.3rem;">
                    </div>
                </div>
                <div style="margin-bottom:1.2rem;">
                    <label style="font-weight:500;">Photo</label><br>
                    <img src="<?= htmlspecialchars($therapist['therapist_photo'] ?? '/public/assets/images/profile.png') ?>" alt="Therapist" style="height:48px;width:48px;border-radius:12px;object-fit:cover;background:#eee;margin-bottom:0.7rem;">
