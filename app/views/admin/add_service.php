  ...
  <div style="
    ...
    <main style="flex:1;font-family:'Segoe UI',Roboto,Arial,sans-serif;">
        ...
        <div style="max-width:600px;margin:2.5rem auto 2rem auto;background:#f8fafd;padding:2rem 2rem 1.5rem 2rem;border-radius:1.2rem;box-shadow:0 2px 8px rgba(0,0,0,0.04);">
            ...
            <h3 style="font-size:1.2rem;font-weight:600;margin-bottom:1.2rem;color:#232a32;">Add New Service</h3>
            <?php if (!empty($msg)) echo $msg; ?>
            <form method="post">
                <div style="display:flex;gap:1.2rem;flex-wrap:wrap;">
                    <div style="flex:1;min-width:180px;margin-bottom:1rem;">
                        <label style="font-weight:500;">Service Name</label>
                        <input type="text" name="service_name" class="form-control" required style="width:100%;padding:0.7rem 1rem;border-radius:0.7rem;border:1.5px solid #e6eaf3;font-size:1.05rem;margin-top:0.3rem;">
                    </div>
                    <div style="flex:1;min-width:180px;margin-bottom:1rem;">
                        <label style="font-weight:500;">Duration (min)</label>
                        <input type="number" name="service_duration" class="form-control" required style="width:100%;padding:0.7rem 1rem;border-radius:0.7rem;border:1.5px solid #e6eaf3;font-size:1.05rem;margin-top:0.3rem;">
                    </div>
                </div>
                <div style="margin-bottom:1rem;">
                    <label style="font-weight:500;">Description</label>
                    <textarea name="service_description" class="form-control" required style="width:100%;padding:0.7rem 1rem;border-radius:0.7rem;border:1.5px solid #e6eaf3;font-size:1.05rem;margin-top:0.3rem;"></textarea>
                </div>
                <div style="display:flex;gap:1.2rem;flex-wrap:wrap;">
                    <div style="flex:1;min-width:180px;margin-bottom:1rem;">
                        <label style="font-weight:500;">Price (RM)</label>
                        <input type="number" step="0.01" name="service_price" class="form-control" required style="width:100%;padding:0.7rem 1rem;border-radius:0.7rem;border:1.5px solid #e6eaf3;font-size:1.05rem;margin-top:0.3rem;">
                    </div>
                    <div style="flex:1;min-width:180px;margin-bottom:1rem;">
                        <label style="font-weight:500;">Status</label>
                        <select name="service_status" class="form-control" style="width:100%;padding:0.7rem 1rem;border-radius:0.7rem;border:1.5px solid #e6eaf3;font-size:1.05rem;margin-top:0.3rem;">
                            <option value="1">Active</option>
                            <option value="0">Inactive</option>
                        </select>
                    </div>
                </div>
                <button type="submit" style="background:#3b5998;color:#fff;padding:0.9rem 2.5rem;border-radius:2rem;font-size:1.08rem;font-weight:500;border:none;width:100%;margin-top:0.5rem;">Add Service</button>
            </form>
        </div>
    </main>
</div>
